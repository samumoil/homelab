...
handle_extension() {
    case "${FILE_EXTENSION_LOWER}" in
        ...
        bib|build|c|cfg|cmake|conf|cpp|css|csv|cu|desktop|ebuild|eex|env|\
        ex|exs|go|gpl|h|hpp|hs|ini|java|jl|js|kdl|kt|kvconfig|lock|log|lua|\
        micro|ninja|nix|norg|org|po|pot|py|qmd|rasi|rkt|rktd|rproj|rs|rstheme|\
        scm|scss|service|sh|socket|sql|srt|svelte|toml|tsx|txt|vim|xml|yaml|yml)
